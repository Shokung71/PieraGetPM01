...
void setup() {
  ...
  server.on("/", HTTP_GET, [](AsyncWebServerRequest *request){
    request->send(200, "text/html",
      ...
      "<style>"
      "body { font-family: 'Poppins', sans-serif; background-color: #f7f7f7; color: #333; margin: 0; padding: 0; display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100vh; }"
      "h1 { color: #187498; font-size: 3rem; margin-bottom: 20px; }"
      ...
      ".data-item { background-color: #BFECFF; color: black; padding: 15px 25px; border-radius: 10px; width: 180px; text-align: center; font-size: 1.2rem; }"
      ...
      "<div class='data-item' id='itemPm01'><i class='fas fa-cloud-sun'></i><div class='label'>PM0.1</div><div id='pm01' class='value'>--</div></div>"
      ...
      "  let iconColor;"
      "  if (pmValue <= 50) iconColor = 'green';"
      "  else if (pmValue <= 100) iconColor = 'yellow';"
      "  else if (pmValue <= 150) iconColor = 'orange';"
      "  else if (pmValue <= 200) iconColor = 'red';"
      "  else if (pmValue <= 300) iconColor = 'purple';"
